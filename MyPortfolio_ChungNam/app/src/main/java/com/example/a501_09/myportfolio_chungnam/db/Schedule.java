...
public class Schedule {
    ...
    @Generated
    public Schedule(Long id, java.util.Date created_at, java.util.Date update_at, String place_name, java.util.Date visit_time, java.util.Date elapse_time, Long spend_money, long place_id, long trip_id) {
        this.id = id;
